...
solver_solve_type = CFUNCTYPE(	c_int,
								POINTER(GSL_vector),
								POINTER(GSL_vector),
								c_void_p,
								c_void_p
...
Initialize_Triples_Fitter_Split =  FitterLib.Initialize_Triples_Fitter_Split
Fit_Triples_Bundle_Split =  FitterLib.Fit_Triples_Bundle_Split
...
Initialize_Triples_Fitter_Split (byref(MyGSLBundle),byref(TestWorkspace))
...
print ("ArraySize %d" % TestWorkspace[0].f[0].size)

Constants = ConstantsType (3000.0,2000.0,1000.0)
Fit_Triples_Bundle_Split 	(	MyTriple,
 						Constants,
 						byref(FitResults),
 						byref(MyCatalog),
 						CatalogStateCount,
